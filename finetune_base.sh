...
output_name='pair-bs288-lr2e-7-neg5'
finetune_epoch=20
eval_batch_size=288  # 对于pair，需要时neg+1的倍数；对于list，需要是neg+pos的倍数
negative_num=5  # 对于list，就是pos和doc各取几个
pos_num=10
lr=2e-7
tem=1
...
CUDA_VISIBLE_DEVICES=1 python -u finetune.py \
    ...
    --init_parameters 'data/pre_model/baidu_ultr_12l_12h_768e.model' \
